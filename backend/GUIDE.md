...
| `POST` | `/api/v1/documents/bulk/trash` |
| `POST` | `/api/v1/documents/{id}/restore` |
| `POST` | `/api/v1/documents/bulk/restore` |
| `POST` | `/api/v1/documents/bulk/permanent` |
