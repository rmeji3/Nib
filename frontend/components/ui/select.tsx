...
function Select({
  ...
  /** Accepted for Base UI compatibility; Radix Select has no modal mode. */
  modal?: boolean
}) {
  void modal // intentionally ignored — Radix Select has no modal mode
...
function SelectContent({
  ...
  /** Base UI compat: aligns the selected item with the trigger (Radix "item-aligned"). */
  alignItemWithTrigger?: boolean
}) {
  const resolvedPosition = alignItemWithTrigger ? "item-aligned" : position
  return (
