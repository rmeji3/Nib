...
import { useSettings } from '@/app/settings/hooks/use-settings';
...
export const AnimatedThemeToggle = ({ className }: { className?: string }) => {
  ...
  // Square button sizing shared across the placeholder and live states
  const square = 'h-10 w-10 p-0';

  // Show a placeholder during SSR to avoid hydration mismatch
  if (!mounted) {
    return (
      <Button className={cn(square, className)} disabled>
